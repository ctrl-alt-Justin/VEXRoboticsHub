...
import { Calendar, Activity, Users, ChevronRight, LogOut, Bell, LayoutDashboard, Package, Settings, FileText, Menu, X } from 'lucide-react';
        ...
        <div className="min-h-screen bg-black text-white overflow-hidden relative">
                ...
                <div className="h-20 flex items-center justify-between px-4 md:px-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-lg font-bold hidden sm:block">VEX Robotics Hub</span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Link to="/" className="flex items-center gap-2 px-3 py-2 hover:bg-white/5 rounded-lg transition-colors text-sm">
            ...
            {!rightSidebarOpen && (
                <motion.button
                    ...
                    className="fixed right-4 top-20 p-2 bg-gradient-to-br from-red-500 to-orange-500 rounded-full shadow-lg hover:scale-110 transition-transform z-40 hidden lg:block"
                >
